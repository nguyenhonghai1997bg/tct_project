    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{ __('categories.lists') }}</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          <form id="update-form">
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">{{ __('categories.name') }}:</label>
              <input type="text" class="form-control" id="name-edit" name="name">
              <input type="hidden" name="id" id="id-edit">
            </div>
            <div class="form-group">
              <label for="recipient-name" class="col-form-label">{{ __('categories.catalog') }}:</label>
              <select class="form-control" name="catalog_id" id="catalog_id_update">
                <option selected value="">-- {{ __('categories.catalog') }} --</option>
                @foreach($catalogs as $catalog)
